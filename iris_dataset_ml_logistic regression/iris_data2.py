# -*- coding: utf-8 -*-
"""
Created on Sat Jan 25 23:56:57 2020
...
ptlwid = pd.get_dummies(dataset_iris['petal_width'],drop_first =True)

dataset_iris = pd.concat([dataset_iris,ptlwid],axis =1)

dataset_iris.drop(['petal_width'],axis =1 ,inplace = True)
